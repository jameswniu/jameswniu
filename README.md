...
| 7 | [semantic-search-rerank-pipeline](https://github.com/jameswniu/semantic-search-rerank-pipeline) | Three-stage retrieval over a vector database: Voyage-3 embedding retrieval, hard-criteria filtering, then GPT-4o-mini reranking |
