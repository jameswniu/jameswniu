...
| 7 | [vector-search-llm-rerank-pipeline](https://github.com/jameswniu/vector-search-llm-rerank-pipeline) | Three-stage retrieval over a vector database: Voyage-3 embedding retrieval, hard-criteria filtering, then GPT-4o-mini reranking |
