...
| If you want | Go to |
| --- | --- |
| One project, read deeply | [The featured harness](#featured-three-hard-problems-in-ai-multimodal-pipelines) |
...
## Featured: Three hard problems in AI multimodal pipelines
